        ...
        @foreach($groupPosts as $post)
            <div class="main-content posted-content">
                ...
                <div class="post-body">
                    ...
                    @endif
                    {{--                    <div class="post-img">--}}
                    {{--                        <img src="{{asset("community-frontend/assets/images/community/home/news-post/post-1.jpg")}}"--}}
                    {{--                             alt="">--}}
                    {{--                    </div>--}}
...
{{--                        '_token': '{{csrf_token()}}'--}}
                    ...
                    success: function (response) {
                        ...
                        if (response.success === true) {
                            ...
                            $('#react-icon').html('');
                            $('#react-icon').html(`<div class="react-icon" id="react-icon">
                                    <img src="${img_src}"
                                            alt="React">
                                </div>`)
                            console.log(img_src, 'img_src');
{{--                            <?php--}}
{{--                            echo $storePostReaction;--}}
{{--                            ?>--}}
                        } else {
    ...
    // $(document).ready(function () {
    //     $('.react-option li img').on('click', function () {
    //         let getReactionlogggg = $(this).attr('src');
    //         // console.log(getReactionlogggg);
    //         $('#react-icon').html('');
    //         $('#react-icon').html(`<div class="react-icon" id="react-icon">
    //                                 <img src="${getReactionlogggg}"
    //                                         alt="React">
    //                             </div>`)
    //     });
    //})
