...
@section('frontend.content')
    ...
    <div class="news-feed-content">
        <!-- help and support page wrapper start -->
        <div class="help-issu-box">
            <h6>How can we help you?</h6>
            <form class="search_box issu-search">
        ...
        <!-- help and support page wrapper end -->
    </div>
        ...
        <div class="chat-wrapper">
            <div class="live-chat">
                ...
                <ul class="contact-widget">
                    <li>
                        <div class="contact-img"><a href="#"><img src="../assets/images/community/home/right/birthday01.jpg" alt="img"></a>
