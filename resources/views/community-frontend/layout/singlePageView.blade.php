...
@section('group.mainProfile')
    @include('community-frontend.layout.pageProfile',['isAdmin'=>$isAdmin])
        ...
        @forelse($pagePosts as $post)
            <div class="main-content posted-content">
                    ...
                    <div class="post-option">
                        ...
                        @if($isAdmin)
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <li>
                                    <a href="#" data-mediaDetails="{{$post->post_image_video}}"
                                       data-postDetails="{{$post->post_description}}"
                                       data-postId="{{$post->pagePostId}}"
                ...
                <div class="post-body">
                    ...
                    @if($post->post_image_video!=null)

                        @php
                            $extension=explode('.',$post->post_image_video  );
                        @endphp
                            ...
                            $extension[2]==='mkv'||$extension[2]==='webm')
                                <div class="post-img">
                                    <video width="550" height="240" controls>
                                        <source
                                            src="{{asset("storage/community/page-post/videos/".$post->post_image_video)}}"
                                            type="video/mp4">
                                    </video>
                                </div>
                            @else
                                <div class="post-img">
                                    <img src="{{asset("storage/community/page-post/".$post->post_image_video)}}" alt="">
                                </div>
                            @endif
                        ...
                        <li class="post-react like-react">
                            ...
                            <ul class="react-option">
                                ...
                                <li class="reaction {{$post->reaction_type=='like'?'active':''}}"
                                    data-reaction_type="like" data-pId="{{$post->pId}}"><img
                                        src="{{asset("community-frontend/assets/images/community/home/news-post/react-1.png")}}"
                                        alt="React">
                                </li>
                                <li class="reaction {{$post->reaction_type=='love'?'active':''}}"
                                    data-reaction_type="love" data-pId="{{$post->pId}}"><img
                                        src="{{asset("community-frontend/assets/images/community/home/news-post/react-2.png")}}"
                                        alt="React">
                                </li>
                                ...
                                <li class="reaction {{$post->reaction_type=='haha'?'active':''}}"
                                    data-reaction_type="haha" data-pId="{{$post->pId}}"><img
                                        src="{{asset("community-frontend/assets/images/community/home/news-post/react-4.png")}}"
                                        alt="React"></li>
                                <li class="reaction {{$post->reaction_type=='wow'?'active':''}}"
                                    data-reaction_type="wow" data-pId="{{$post->pId}}"><img
                                        src="{{asset("community-frontend/assets/images/community/home/news-post/react-5.png")}}"
                                        alt="React"></li>
                                <li class="reaction {{$post->reaction_type=='sad'?'active':''}}"
                                    data-reaction_type="sad" data-pId="{{$post->pId}}"><img
                                        src="{{asset("community-frontend/assets/images/community/home/news-post/react-6.png")}}"
                                        alt="React"></li>
                            ...
                            <li class="single-comment post-Comment-{{$postComment->id}}">
                                <div class="parent-comment">
                                    ...
                                    <div class="comment-details">
                                        ...
                                        @php
                                            $countCommentReaction=\App\Models\Community\Page\CommunityPagePostCommentReaction::where('page_post_comment_id','=',$postComment->id)->count();
                                        @endphp
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.cmtReaction', function (e) {
            ...
            if($(this).hasClass('acitve')){
                ...
                $.ajax({
                    url: '{{route('user.post.rmv-page-reaction')}}',
                    type: "POST",
                    data: {
                ...
                // return false;
                $.ajax({
                    url: '{{route('user.post.page.cmt-reaction')}}',
                    type: "POST",
                    data: {
...
<script>
    $(document).on('click', '.dltPost', function (event) {
        ...
        Swal.fire({
            ...
            /* Read more about isConfirmed, isDenied below */
            if (result.isConfirmed) {
                let url = '{{ route("user.page.post.dlt", ":slug") }}';
