...
@section('frontend.content')
    <div class="col-lg-6">
        ...
        <div class="main-content create-post">
            ...
            <form action="{{route('community.user.post')}}" class="input-psot" method="post" enctype="multipart/form-data">
                @csrf
                                ...
                                <div class="modal-content post-modal-content">
                                    ...
                                    <div class="modal-body post-modal-body">
                                        <div class="my-profile">
                                            <div class="my-profile-img"><a href="#"><img src="{{asset("community-frontend/assets/images/community/home/right/birthday01.jpg")}}" alt="img"></a></div>
                                            ...
                                            @foreach(myFriends() as $friends)
                                                <li class="suggestion-option">
                                                    <div class="my-profile-img">
                                                        <img src="{{asset("community-frontend/assets/images/community/home/right/birthday01.jpg")}}" alt="img">
                                                    </div>
                                                    <div class="my-profile-name" data-id="{{$friends->uId}}">{{$friends->userName}}</div>
                                                    <label><input type="checkbox" name="tagId[]" value="{{$friends->uId}}"></label>
                                                </li>
                                            @endforeach
