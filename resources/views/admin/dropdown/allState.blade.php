...
{{--                            @dd($allStates)--}}
                            ...
                            @foreach($allStates as $state)
                                <tr>
                                    ...
                                    <td class="country_name" data-id="{{$state->id}}">{{$state->countries->country}} </td>
                                    <td>
                                        <button class="btn btn-warning btnEdit" data-bs-toggle="modal"
                                                data-bs-target="#centermodal1"><i
                                                class=" fa-solid fa-pen-to-square"></i></button>
                                        {{--                                        <a href="" class="btn btn-warning">Edit</a>--}}
                                        <a href="{{route('user.delete.country',$state->id)}}" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
