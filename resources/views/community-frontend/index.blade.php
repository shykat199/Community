...
{{--                @dd($allUserPosts)--}}
        @foreach($allUserPosts as $post)
            ...
            {{--                $postDescription=explode(',',$post->postDescription);--}}
            {{--                $created_at=explode(',',$post->created_at);--}}
            {{--                $post_id=explode(',',$post->post_id);--}}
            {{--                $userPostMedia=explode(',',$post->userPostMedia);--}}
            {{--                $caption=explode(',',$post->caption);--}}
            {{--                $user_profile=explode(',',$post->user_profile);--}}
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            ...
                            @foreach($isOwner as $owner)
                                @if($post->postId==$owner->id)
                                    <li><a href="#" data-postId="{{$post->postId}}" data-bs-toggle="modal" data-bs-target="#exampleModal" class="post-option-item"><i class="fa fa-pencil-square-o"
                                                                                aria-hidden="true"></i> Edit Post</a>
                                    </li>
                    ...
                    <ul class="post-react-widget">
                        <li class="post-react like-react">
                            <a href="#">
                                ...
                                {{--                                @dd( countComments())--}}
                                <span
                                    class="react-count">{{getUserTimeLinePostReactionCount($post->postId)}}</span>
                            </a>

                            <ul class="react-option">
                                <li class="reaction {{$post->reaction_type=='like'?'active':''}}" data-reaction_type="like" data-gId="{{$post->grpPostId}}">
                                    <img
                                        src="{{asset("community-frontend/assets/images/community/home/news-post/react-1.png")}}"
                                        alt="React">
                                </li>
                                {{--                                @dd($post)--}}
                                <li class="reaction {{$post->reaction_type=='love'?'active':''}}" data-reaction_type="love" data-gId="{{$post->grpPostId}}"><img
                                        src="{{asset("community-frontend/assets/images/community/home/news-post/react-2.png")}}"
                                        alt="React"></li>
                                <li class="reaction {{$post->reaction_type=='care'?'active':''}}" data-reaction_type="care" data-gId="{{$post->grpPostId}}"><img
                                        src="{{asset("community-frontend/assets/images/community/home/news-post/react-3.png")}}"
                                        alt="React"></li>
                                <li class="reaction {{$post->reaction_type=='haha'?'active':''}}" data-reaction_type="haha" data-gId="{{$post->grpPostId}}"><img
                                        src="{{asset("community-frontend/assets/images/community/home/news-post/react-4.png")}}"
                                        alt="React"></li>
                                <li class="reaction {{$post->reaction_type=='wow'?'active':''}}" data-reaction_type="wow" data-gId="{{$post->grpPostId}}"><img
                                        src="{{asset("community-frontend/assets/images/community/home/news-post/react-5.png")}}"
                                        alt="React"></li>
                                <li class="reaction {{$post->reaction_type=='sad'?'active':''}}" data-reaction_type="sad" data-gId="{{$post->grpPostId}}"><img
                                        src="{{asset("community-frontend/assets/images/community/home/news-post/react-6.png")}}"
                                        alt="React"></li>
                                <li class="reaction {{$post->reaction_type=='angry'?'active':''}}" data-reaction_type="care" data-gId="{{$post->grpPostId}}"><img
                        ...
                        <li class="post-react">
                            <a href="#">
                                ...
                                <span
                                    class="react-count">{{getUserTimeLinePostCommentCount($post->postId)}}</span>
