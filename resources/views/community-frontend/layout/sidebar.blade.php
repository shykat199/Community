<div class="side-nav-wrapper">
    <div id="mySidenav" class="sidenav community-sidenav">
        ...
        <ul class="sidebar-list">
            ...
            <li class="single-side">
                <a href="{{route('all.requested.friend.users')}}">
                            <span class="side-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0" y="0"
            ...
            <li class="single-side">
                <a href="{{route('user.all.pages')}}">
                    ...
                    <span class="side-title">Pages</span>
                </a>
            </li>
            <li class="single-side">
                <a href="#">
            ...
            <li class="single-side">
                <a href="{{route('user.friend.birthday.wish')}}">
                            <span class="side-icon">
